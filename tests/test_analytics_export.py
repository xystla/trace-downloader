...
def _sample():
    g = GameStats(game_id=1, date="2026-09-12", opponent="Latterman",
                  ...
                  territory_us=Territory(30.0, 30.0, 40.0), match_secs_us=3000)
    season = SeasonStats(1, 600.0, 20.0, 7, 2, 1, 1, 1, 1, Territory(30.0, 30.0, 40.0))
    return [g], season
...
def test_csv_has_header_row_and_game(tmp_path):
    ...
    assert lines[0].startswith("date,opponent,ball_control_min,possession_pct,passes")
